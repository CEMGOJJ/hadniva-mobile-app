...
const LogIn = ({ navigation }) => {
  ...
  const handleLogin = () => {
    ...
    // Navigate to the main app screen (you'll need to set up navigation)
  ...
  const handleSignUp = () => {
    // Navigate to the sign up screen (you'll need to set up navigation)
    // navigation.navigate('SignUp');
    Alert.alert("Sign Up", "Navigate to sign up screen (not implemented)");
  };
...
const LogIn = () => {
  ...
  const handleSignUp = () => {Alert.alert("sign in successful")
...
const LogIn = () => {
  ...
  const handleLogin = () => {
    if (email && password) {
      ...
      Alert.alert("Login Successful", `Welcome back, ${email}!`, [
        {
          text: "OK",
          onPress: () => navigation.replace("EntireHomeScreen")
        }
      ]);
    } else {
      Alert.alert("Error", "Please enter both email and password");
  ...
  const handleSignUp = () => {
    Alert.alert("Sign Up", "Navigate to sign up screen (not implemented)");
    // If you have a SignUp screen, you can navigate to it like this:
    // navigation.navigate("SignUp");
  };
